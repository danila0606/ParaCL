...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_LFB (location_type l)
      {
        return symbol_type (token::LFB, std::move (l));
      }
#else
      static
      symbol_type
      make_LFB (const location_type& l)
      {
        return symbol_type (token::LFB, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RFB (location_type l)
      {
        return symbol_type (token::RFB, std::move (l));
      }
#else
      static
      symbol_type
      make_RFB (const location_type& l)
      {
        return symbol_type (token::RFB, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
